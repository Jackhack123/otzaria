...
String replaceParaphrases(String s) {
  s = s
      ...
      .replaceAll(' אא', ' אשל Avרהם')
      .replaceAll(' Avהע', ' Avן העזר')
      .replaceAll(' Avעז', ' Avן עזרא')
      .replaceAll(' אדז', ' Adarא זוטא')
      .replaceAll(' Adarא רבה', ' Adarא')
      .replaceAll(' Adarות', ' Adarא')
      .replaceAll(' אהע', ' Avן העזר')
      .replaceAll(' אהעז', ' Avן העזר')
      .replaceAll(' אוהח', ' אור החיים')
      .replaceAll(' אוח', ' אורח חיים')
      .replaceAll(' אורח', ' אורח חיים')
      .replaceAll(' אידרא', ' Adarא')
      .replaceAll(' אידרות', ' Adarא')
      ...
      .replaceAll(' ר', ' רבינו')
      .replaceAll(' ר', ' רבנו')
      .replaceAll(' רא בהרמ', ' רבי Avרהם בן הרמבם')
      .replaceAll(' ראבע', ' Avן עזרא')
